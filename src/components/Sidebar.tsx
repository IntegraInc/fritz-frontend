...
export function Sidebar() {
  return (
    <aside className="flex min-h-screen w-72 flex-col bg-gradient-to-b from-fritz-green-800 via-fritz-bright-800 to-fritz-bright-950 p-6 text-white shadow-xl">
      <div className="mb-10">
      ...
      <nav className="space-y-3">
        <Link
          href="/produtos"
          className="block rounded-xl bg-black/20 px-4 py-3 text-sm font-semibold shadow-sm transition hover:bg-white/15"
        >
          Produtos
        </Link>
